            ...
            public void run() {
                ...
                for (int i=0; i<15; i++) {
                    ...
                    count ++;
                        ...
                        try {
                            Thread.sleep(1000);  // 1000 ms = 1 second  每1秒冲运行一次
                                ...
                                public void run() {
                                    ...
                                    if(top >=1){
                                        ...
                                        if ( top ==1){
                                            ...
                                            int i = leftMargin +marginofaddview1; // the left margin of
                                            m1 = new Money(i);
                                        ...
                                        if (top >1){
                                            ...
                                            int i =m1.Returnnumber(); //

                                        }

                                        final int i = leftMargin +leftMargin;
                                        ...
                                        textView.setText("the left maigin of the addview is "+ i +" px  " + top);
